...
func TestCreateAddress_InvalidBody_ReturnsStructuredError(t *testing.T) {
	h := NewAddressHandler(nil)

	rr := httptest.NewRecorder()
	req := httptest.NewRequest("POST", "/addresses", bytes.NewBufferString("not-json"))
