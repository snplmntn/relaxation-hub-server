...
func (m *mockBookingRepoUnassign) ListByClient(ctx context.Context, clientID int64) ([]model.Booking, error) { return nil, nil }
func (m *mockBookingRepoUnassign) Update(ctx context.Context, booking *model.Booking) error { return nil }
...
func (m *mockBookingRepoUnassign) GetBookingWithDetailsUnsafe(ctx context.Context, bookingID int64) (*repository.BookingDetailsResult, error) { return nil, nil }
func (m *mockBookingRepoUnassign) GetBookingByCodeWithDetails(ctx context.Context, referenceCode string, userID int64) (*repository.BookingDetailsResult, error) { return nil, nil }
func (m *mockBookingRepoUnassign) GetBookingByCodeWithDetailsUnsafe(ctx context.Context, referenceCode string) (*repository.BookingDetailsResult, error) { return nil, nil }
func (m *mockBookingRepoUnassign) ListByClientWithDetails(ctx context.Context, clientID int64) ([]repository.BookingDetailsResult, error) { return nil, nil }
func (m *mockBookingRepoUnassign) ListByTherapistWithDetails(ctx context.Context, therapistID int64) ([]repository.BookingDetailsResult, error) { return nil, nil }
func (m *mockBookingRepoUnassign) ListGlobalPending(ctx context.Context) ([]model.Booking, error) { return nil, nil }
func (m *mockBookingRepoUnassign) GetTherapistBookingCounts(ctx context.Context, therapistIDs []int64, since time.Time) (map[int64]int, error) { return nil, nil }
func (m *mockBookingRepoUnassign) SetPauseStart(ctx context.Context, bookingID int64, pauseStart *time.Time) error { return nil }
func (m *mockBookingRepoUnassign) ClearPauseAndAddDuration(ctx context.Context, bookingID int64, totalPausedSeconds int) error { return nil }
func (m *mockBookingRepoUnassign) ListInProgressBookings(ctx context.Context) ([]model.Booking, error) { return nil, nil }
func (m *mockBookingRepoUnassign) ListByClientWithDetailsPaginated(ctx context.Context, clientID int64, limit, offset int) ([]repository.BookingDetailsResult, int, error) { return nil, 0, nil }
...
func (m *mockTherapistRepoUnassign) GetProfile(ctx context.Context, therapistID int64) (*model.TherapistProfile, error) { return nil, nil }
func (m *mockTherapistRepoUnassign) List(ctx context.Context, availableOnly bool) ([]model.TherapistProfile, error) { return nil, nil }
func (m *mockTherapistRepoUnassign) UploadDocument(ctx context.Context, doc *model.TherapistDocument) error { return nil }
func (m *mockTherapistRepoUnassign) GetDocuments(ctx context.Context, therapistID int64) ([]model.TherapistDocument, error) { return nil, nil }
func (m *mockTherapistRepoUnassign) VerifyDocument(ctx context.Context, documentID, verifierID int64, status string) error { return nil }
func (m *mockTherapistRepoUnassign) AddService(ctx context.Context, ts *model.TherapistService) error { return nil }
func (m *mockTherapistRepoUnassign) RemoveService(ctx context.Context, therapistID, serviceID int64) error { return nil }
func (m *mockTherapistRepoUnassign) GetServices(ctx context.Context, therapistID int64) ([]int64, error) { return nil, nil }
func (m *mockTherapistRepoUnassign) SetServicePressures(ctx context.Context, therapistID, serviceID int64, pressures []string) error { return nil }
...
func (m *mockUserRepoUnassign) CreateUserAndIdentity(ctx context.Context, user model.User, identity model.UserAuthIdentity) error { return nil }
func (m *mockUserRepoUnassign) FindIdentityByKey(ctx context.Context, provider, key string) (*model.UserAuthIdentity, error) { return nil, nil }
func (m *mockUserRepoUnassign) FindUserByID(ctx context.Context, userID int) (*model.User, error) { return nil, nil }
func (m *mockUserRepoUnassign) UpdateUser(ctx context.Context, userID int64, updates map[string]interface{}) error { return nil }
...
func (m *mockUserRepoUnassign) GetFCMToken(ctx context.Context, userID int64) (*string, error) { s := ""; return &s, nil }
func (m *mockUserRepoUnassign) GetUserInfoBatch(ctx context.Context, userIDs []int64) (map[int64]*repository.UserInfo, error) { return nil, nil }
func (m *mockUserRepoUnassign) GetTherapistInfoBatch(ctx context.Context, therapistIDs []int64) (map[int64]*repository.TherapistInfo, error) { return nil, nil }
func (m *mockUserRepoUnassign) AddFavoriteTherapist(ctx context.Context, userID, therapistID int64) error { return nil }
func (m *mockUserRepoUnassign) RemoveFavoriteTherapist(ctx context.Context, userID, therapistID int64) error { return nil }
func (m *mockUserRepoUnassign) ListFavoriteTherapists(ctx context.Context, userID int64) ([]model.User, error) { return nil, nil }
func (m *mockUserRepoUnassign) IsTherapistFavorite(ctx context.Context, userID, therapistID int64) (bool, error) { return false, nil }
func (m *mockUserRepoUnassign) BanUserSystem(ctx context.Context, userID int64, reason string) error { return nil }
func (m *mockUserRepoUnassign) Create(ctx context.Context, user *model.User) error { return nil }
func (m *mockUserRepoUnassign) GetByID(ctx context.Context, userID int64) (*model.User, error) { return nil, nil }
func (m *mockUserRepoUnassign) GetByPhone(ctx context.Context, phone string) (*model.User, error) { return nil, nil }
func (m *mockUserRepoUnassign) Update(ctx context.Context, user *model.User) error { return nil }
func (m *mockUserRepoUnassign) SetOneSignalPlayerID(ctx context.Context, userID int64, playerID string) error { return nil }
...
func (m *mockNotificationRepoCapture) ListByUser(ctx context.Context, userID int64, limit, offset int) ([]model.Notification, int, error) { return nil, 0, nil }
func (m *mockNotificationRepoCapture) MarkAsRead(ctx context.Context, notificationID int64, userID int64) error { return nil }
func (m *mockNotificationRepoCapture) CountUnread(ctx context.Context, userID int64) (int, error) { return 0, nil }
func (m *mockNotificationRepoCapture) DeleteOld(ctx context.Context, olderThan time.Duration) error { return nil }
