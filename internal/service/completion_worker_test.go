...
func (m *mockBookingRepoCW) CompleteBooking(ctx context.Context, bookingID int64, earnings, fee *float64, actualEnd time.Time) error {
	if m.completed == nil { m.completed = make(map[int64]model.Booking) }
...
func (m *mockBookingRepoCW) InsertEvent(ctx context.Context, bookingID int64, eventType string, actorID *int64, metadata map[string]any) error { return nil }

// Stubs for BookingRepository
func (m *mockBookingRepoCW) Create(ctx context.Context, booking *model.Booking) error { return nil }
func (m *mockBookingRepoCW) CreateTx(ctx context.Context, tx pgx.Tx, booking *model.Booking) error { return nil }
...
func (m *mockBookingRepoCW) GetByBookingIDForUpdateTx(ctx context.Context, tx pgx.Tx, bookingID int64) (*model.Booking, error) { return nil, nil }
...
func (m *mockBookingRepoCW) GetBookingWithDetailsUnsafe(ctx context.Context, bookingID int64) (*repository.BookingDetailsResult, error) { return nil, nil }
func (m *mockBookingRepoCW) GetBookingByCodeWithDetails(ctx context.Context, referenceCode string, userID int64) (*repository.BookingDetailsResult, error) { return nil, nil }
func (m *mockBookingRepoCW) GetBookingByCodeWithDetailsUnsafe(ctx context.Context, referenceCode string) (*repository.BookingDetailsResult, error) { return nil, nil }
func (m *mockBookingRepoCW) ListByClientWithDetails(ctx context.Context, clientID int64) ([]repository.BookingDetailsResult, error) { return nil, nil }
func (m *mockBookingRepoCW) ListByTherapistWithDetails(ctx context.Context, therapistID int64) ([]repository.BookingDetailsResult, error) { return nil, nil }
...
func (m *mockBookingRepoCW) GetDailyAccounting(ctx context.Context, startDate, endDate time.Time) ([]repository.DailyAccountingEntry, error) { return nil, nil }
...
func (m *mockServiceRepoCW) GetByID(ctx context.Context, serviceID int64) (*model.Service, error) {
	if m.services != nil {
		if s, ok := m.services[serviceID]; ok { return s, nil }
	}
...
func (m *mockPaymentRepoCW) GetByBookingID(ctx context.Context, bookingID int64) (*model.Payment, error) {
	if m.payments != nil {
		if p, ok := m.payments[bookingID]; ok { return p, nil }
	}
	return nil, nil
}
func (m *mockPaymentRepoCW) GetByBookingIDBatch(ctx context.Context, bookingIDs []int64) (map[int64]*model.Payment, error) {
	...
	if m.payments != nil {
		for _, id := range bookingIDs {
			if p, ok := m.payments[id]; ok { result[id] = p }
		}
	}
	return result, nil
}
