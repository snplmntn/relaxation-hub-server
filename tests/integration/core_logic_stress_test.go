...
func TestStress_CoreLogic(t *testing.T) {
	...
	t.Run("Geofencing Rules", func(t *testing.T) {
		...
		_, err = bookingGroupService.CreateBookingGroup(ctx, clientID, clientID, req1, true)
		...
		_, err = bookingGroupService.CreateBookingGroup(ctx, clientID, clientID, req2, true)
		if err == nil {
		...
		_, err = bookingGroupService.CreateBookingGroup(ctx, clientID, clientID, req3, true)
